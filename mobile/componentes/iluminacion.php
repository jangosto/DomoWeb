...
<div id="iluminacion">
	<div class="relativizador">
        ...
        <div id="divcontrolautoluz">
            <button value="<?php echo $autoLuzEncendido?>" class="btn-<?php if($autoLuzEncendido===true){echo "success";}else{echo "danger";}?>"><?php if($autoLuzEncendido===true){echo "Desactivar";}else{echo "Activar";}?> Autoluz</button>
        </div>
		<!--div id="divindicaluz">
